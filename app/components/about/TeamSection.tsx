    ...
    <section className="relative py-24 overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800">
      ...
      <div className="container relative mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Our team is composed of passionate professionals with diverse expertise, working together to bring exceptional outcomes for each client.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-xl bg-gray-800/50 backdrop-blur-sm p-6 border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 transform hover:-translate-y-2">
                ...
                >
                  ...
                  <a
                    ...
                    className="p-2 rounded-full bg-gray-700 hover:bg-blue-400 transition-colors"
                  >
